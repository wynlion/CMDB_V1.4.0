module.exports = function(grunt){
    ...
    // Code check tasks.
    grunt.registerTask('lint-js', 'Lint all js media with jshint and jscs', ['jshint', 'jscs']);
    grunt.registerTask('lint-css', 'Lint all css media', ['dist-css', 'csslint:dist']);
    grunt.registerTask('qunit-all', 'Run qunit tests', ['qunit:main', 'qunit-timezone']);
    grunt.registerTask('test', 'Lint media and run unit tests', ['lint-js', /*'lint-css',*/ 'qunit-all']);
