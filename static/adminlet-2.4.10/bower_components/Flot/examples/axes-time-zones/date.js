// -----
// The `timezoneJS.Date` object gives you full-blown timezone support, independent from the timezone set on the end-user's machine running the browser. It uses the Olson zoneinfo media for its timezone data.
//
...
(function () {
  ...
  var _transport = function (opts) {
    if ((!fleegix || typeof fleegix.xhr === 'undefined') && (!$ || typeof $.ajax === 'undefined')) {
      throw new Error('Please use the Fleegix.js XHR module, jQuery ajax, Zepto ajax, or define your own transport mechanism for downloading zone media.');
    }
    if (!opts) return;
  ...
  timezoneJS.timezone = new function () {
    ...
    function builtInLoadZoneFile(fileName, opts) {
      ...
      : _this.transport({
        ...
        error : function () {
          throw new Error('Error retrieving "' + url + '" zoneinfo media');
        }
      });
    }
    ...
    this.init = function (o) {
      ...
      // sure all media have been loaded.
    ...
    //Get the zone media via XHR -- if the sync flag
