...
module.exports = function (grunt) {
  ...
  grunt.registerTask('build-customizer', ['build-customizer-html', 'build-raw-media']);
  grunt.registerTask('build-customizer-html', 'pug');
  grunt.registerTask('build-raw-media', 'Add scripts/less media to customizer.', function () {
